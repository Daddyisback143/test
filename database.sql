...
('Dubai Luxury Tour', 'international', 4, 3, '["Dubai", "Abu Dhabi"]', 37999.00, 'Included', '["Burj Al Arab View Hotel", "City Max"]', '["Flight", "Cab"]', 'https://images.unsplash.com/photo-1589308078059-be1415eab4c3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', '4 days, 3 nights. Burj Khalifa, desert safari, city tour.');
...
('Dubai', 'International', 'city', 'Modern metropolis with skyscrapers, desert adventures, and luxury shopping.', 'https://www.bing.com/images/search?q=dubai+image&id=9360C322277054B5FCB880BC839C4BED2A58B459&FORM=IACFIR', '["Skyscrapers", "Desert Safari", "Shopping"]', 'From ₹55,000');
